...
import { EditOutlined, DeleteOutlined, EyeOutlined, QrcodeOutlined, DownloadOutlined, MoreOutlined, UserOutlined, SearchOutlined } from '@ant-design/icons';
...
export default function ViewAllUsers() {
  ...
  const columns = [
    { 
      ...
      key: '_id',
      responsive: ['md'],
      render: (id) => <Text code style={{ fontSize: 12, fontWeight: 'bold', color: '#1677ff' }}>{id}</Text>
    },
    { 
      title: 'Name', 
      dataIndex: 'name', 
        ...
        <Content style={{ margin: { xs: 12, md: 24 }, background: '#fff', borderRadius: 8, minHeight: 400, padding: { xs: 16, md: 24 } }}>
          <Row justify="space-between" align="middle" style={{ marginBottom: 16 }}>
            <Col>
              ...
              <Text type="secondary" style={{ fontSize: 14 }}>Sorted by ID (ascending order)</Text>
            </Col>
            <Col>
              <Button 
                type="primary" 
                ...
                onClick={() => {
                  const csvContent = [
                    ['User ID', 'Name', 'Email', 'Phone Number', 'NIC', 'School', 'Age', 'Profile Picture URL'],
                  ...
                  link.setAttribute('download', `all_users_sorted_by_id_${new Date().toISOString().split('T')[0]}.csv`);
          ...
          <Row style={{ marginBottom: 16 }}>
            <Col span={24}>
              <Input.Search
                placeholder="Search by name, email, phone, NIC, ID, or school..."
                allowClear
              ...
              {searchText && (
                <div style={{ marginTop: 8 }}>
                  ...
                  {filteredUsers.length === 0 && (
                    <div style={{ marginTop: 8 }}>
                      <Text type="secondary">No users found matching "{searchText}"</Text>
                      <Button 
                        type="link" 
                        size="small" 
                        onClick={clearSearch}
